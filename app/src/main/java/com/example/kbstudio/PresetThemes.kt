...
object PresetThemes {
    ...
    val ALL: List<Preset> = listOf(
        Preset("Mặc định (Laban)", KbTheme.default()),

        Preset("Laban sáng", KbTheme.default().copy(
            bgColor = 0xFFCFE8B4.toInt(),
        ...
        Preset("Retro", KbTheme.default().copy(
            ...
            keyCornerRadiusDp = 4f, keyBorderWidthDp = 1.5f,
        ...
        Preset("Cơ khí", KbTheme.default().copy(
            ...
            keyBorderColor = 0xFF616161.toInt(), keyBorderWidthDp = 1.5f,
